\documentclass[12pt,PhD,wordcount,twoside]{muthesis}
% The regulations say that 12pt should be used
% Change the PhD option to MSc, MPhil, or MRes if appropriate

% Set font type, Calibri and Times New Roman are recommended.
% Note: Compiling by xelatex or lualatex required (not pdflatex).
\usepackage{fontspec}
\setmainfont{Calibri} % Or Times New Roman
...
\usepackage{hyperref} % hyperlinks, a ref: (https://www.overleaf.com/learn/latex/hyperlinks)
...
%\usepackage[T1]{fontenc} % Use T1 font encoding which supports more elemental symbols such as 'ö'
